// $ANTLR 3.3 Nov 30, 2010 12:50:56 MathLang.g 2017-10-16 17:51:37
...
public partial class MathLangLexer : Antlr.Runtime.Lexer
{
	...
	private void mKNEW()
	{
		...
		try
		{
			int _type = KNEW;
			int _channel = DefaultTokenChannel;
			// MathLang.g:182:5: ( 'new' )
			DebugEnterAlt(1);
			// MathLang.g:182:7: 'new'
			{
			DebugLocation(182, 7);
			Match("new"); 
	...
	private void mCONSOLE_WORD()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// MathLang.g:183:13: ( 'Console' )
			DebugEnterAlt(1);
			// MathLang.g:183:15: 'Console'
			{
	...
	private void mARRAY_DECLARATION_MARK()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// MathLang.g:184:23: ( OPEN_SQUARE_BRACE CLOSE_SQUARE_BRACE )
			DebugEnterAlt(1);
			// MathLang.g:184:25: OPEN_SQUARE_BRACE CLOSE_SQUARE_BRACE
			{
	...
	private void mTYPE()
	{
		...
		try
		{
			int _type = TYPE;
			int _channel = DefaultTokenChannel;
			// MathLang.g:189:5: ( 'int' | 'bool' | 'char' )
			int alt1=3;
	...
	private void mVOID()
	{
		...
		try
		{
			int _type = VOID;
			int _channel = DefaultTokenChannel;
			// MathLang.g:190:5: ( 'void' )
			DebugEnterAlt(1);
			// MathLang.g:190:7: 'void'
			{
			DebugLocation(190, 7);
			Match("void"); 
	...
	private void mNUMBER()
	{
		...
		try
		{
			int _type = NUMBER;
			int _channel = DefaultTokenChannel;
			// MathLang.g:191:7: ( ( '0' .. '9' )+ )
			DebugEnterAlt(1);
			// MathLang.g:191:9: ( '0' .. '9' )+
			{
			DebugLocation(191, 9);
			// MathLang.g:191:9: ( '0' .. '9' )+
			int cnt2=0;
	...
	private void mRETURN()
	{
		...
		try
		{
			int _type = RETURN;
			int _channel = DefaultTokenChannel;
			// MathLang.g:197:7: ( 'return' )
			DebugEnterAlt(1);
			// MathLang.g:197:9: 'return'
			{
			DebugLocation(197, 9);
			Match("return"); 
	...
	private void mTRUE()
	{
		...
		try
		{
			int _type = TRUE;
			int _channel = DefaultTokenChannel;
			// MathLang.g:198:5: ( 'true' )
			DebugEnterAlt(1);
			// MathLang.g:198:9: 'true'
			{
			DebugLocation(198, 9);
			Match("true"); 
	...
	private void mFALSE()
	{
		...
		try
		{
			int _type = FALSE;
			int _channel = DefaultTokenChannel;
			// MathLang.g:199:6: ( 'false' )
			DebugEnterAlt(1);
			// MathLang.g:199:9: 'false'
			{
			DebugLocation(199, 9);
			Match("false"); 
	...
	private void mWS()
	{
		...
		try
		{
			int _type = WS;
			int _channel = DefaultTokenChannel;
			// MathLang.g:209:3: ( ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+ )
			DebugEnterAlt(1);
			// MathLang.g:210:3: ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+
			{
			DebugLocation(210, 3);
			// MathLang.g:210:3: ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+
			int cnt3=0;
	...
	private void mMODIFIER()
	{
		...
		try
		{
			int _type = MODIFIER;
			int _channel = DefaultTokenChannel;
			// MathLang.g:215:9: ( 'static' )
			DebugEnterAlt(1);
			// MathLang.g:215:11: 'static'
			{
	...
	private void mID()
	{
		...
		try
		{
			int _type = ID;
			int _channel = DefaultTokenChannel;
			// MathLang.g:218:3: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
			DebugEnterAlt(1);
			// MathLang.g:218:6: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
			{
			DebugLocation(218, 6);
			...
			DebugLocation(219, 9);
			// MathLang.g:219:9: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
	...
	private void mSL_COMMENT()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// MathLang.g:223:11: ( '//' ( options {greedy=false; } : . )* ( '\\r' )? '\\n' )
			DebugEnterAlt(1);
			// MathLang.g:224:3: '//' ( options {greedy=false; } : . )* ( '\\r' )? '\\n'
			{
			DebugLocation(224, 3);
			Match("//"); 

			DebugLocation(224, 8);
			// MathLang.g:224:8: ( options {greedy=false; } : . )*
	...
	private void mML_COMMENT()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// MathLang.g:228:11: ( '/*' ( options {greedy=false; } : . )* '*/' )
			DebugEnterAlt(1);
			// MathLang.g:229:3: '/*' ( options {greedy=false; } : . )* '*/'
			{
			DebugLocation(229, 3);
			Match("/*"); 

			DebugLocation(229, 8);
			// MathLang.g:229:8: ( options {greedy=false; } : . )*
	...
	private class DFA8 : DFA
	{
		...
		public override string Description { get { return "1:1: Tokens : ( PRINT | INPUT | IF | ELSE | FOR | FUNCTION | WHILE | DO | CLASS_WORD | T__69 | T__70 | T__71 | T__72 | KNEW | CONSOLE_WORD | ARRAY_DECLARATION_MARK | OPEN_SQUARE_BRACE | CLOSE_SQUARE_BRACE | OPEN_BRACE | CLOSE_BRACE | TYPE | VOID | NUMBER | ADD | SUB | MUL | DIV | ASSIGN | RETURN | TRUE | FALSE | EQ | NEQ | GR | GREQ | LS | LSEQ | NOT | OR | AND | WS | DOT | MODIFIER | CHAR | ID | SL_COMMENT | ML_COMMENT );"; } }
