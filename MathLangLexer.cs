// $ANTLR 3.3 Nov 30, 2010 12:50:56 MathLang.g 2017-10-01 15:37:22
...
public partial class MathLangLexer : Antlr.Runtime.Lexer
{
	...
	private void mARRAY()
	{
		...
		try
		{
			int _type = ARRAY;
			int _channel = DefaultTokenChannel;
			// MathLang.g:94:6: ( ( TYPE '[]' ) )
			DebugEnterAlt(1);
			// MathLang.g:94:8: ( TYPE '[]' )
			{
			DebugLocation(94, 8);
			// MathLang.g:94:8: ( TYPE '[]' )
			DebugEnterAlt(1);
			// MathLang.g:94:9: TYPE '[]'
			{
			DebugLocation(94, 9);
			mTYPE(); 
			DebugLocation(94, 14);
	...
	private void mACCESS_MODIFIER()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// MathLang.g:96:16: ( 'public' | 'private' )
			int alt2=2;
	...
	private void mTRUE()
	{
		...
		try
		{
			int _type = TRUE;
			int _channel = DefaultTokenChannel;
			// MathLang.g:105:5: ( 'true' )
			DebugEnterAlt(1);
			// MathLang.g:105:8: 'true'
			{
			DebugLocation(105, 8);
			Match("true"); 
	...
	private void mFALSE()
	{
		...
		try
		{
			int _type = FALSE;
			int _channel = DefaultTokenChannel;
			// MathLang.g:106:6: ( 'false' )
			DebugEnterAlt(1);
			// MathLang.g:106:8: 'false'
			{
			DebugLocation(106, 8);
			Match("false"); 
	...
	private void mWS()
	{
		...
		try
		{
			int _type = WS;
			int _channel = DefaultTokenChannel;
			// MathLang.g:117:3: ( ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+ )
			DebugEnterAlt(1);
			// MathLang.g:118:3: ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+
			{
			DebugLocation(118, 3);
			// MathLang.g:118:3: ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+
			int cnt4=0;
	...
	private void mID()
	{
		...
		try
		{
			int _type = ID;
			int _channel = DefaultTokenChannel;
			// MathLang.g:122:3: ( ( 'a' .. 'z' )+ )
			DebugEnterAlt(1);
			// MathLang.g:122:6: ( 'a' .. 'z' )+
			{
			DebugLocation(122, 6);
			// MathLang.g:122:6: ( 'a' .. 'z' )+
			int cnt5=0;
	...
	private void mSL_COMMENT()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// MathLang.g:125:11: ( '//' ( options {greedy=false; } : . )* ( '\\r' )? '\\n' )
			DebugEnterAlt(1);
			// MathLang.g:126:3: '//' ( options {greedy=false; } : . )* ( '\\r' )? '\\n'
			{
			DebugLocation(126, 3);
			Match("//"); 

			DebugLocation(126, 8);
			// MathLang.g:126:8: ( options {greedy=false; } : . )*
	...
	private void mML_COMMENT()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// MathLang.g:130:11: ( '/*' ( options {greedy=false; } : . )* '*/' )
			DebugEnterAlt(1);
			// MathLang.g:131:3: '/*' ( options {greedy=false; } : . )* '*/'
			{
			DebugLocation(131, 3);
			Match("/*"); 

			DebugLocation(131, 8);
			// MathLang.g:131:8: ( options {greedy=false; } : . )*
